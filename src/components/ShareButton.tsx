...
export const ShareButton: React.FC = () => {
  ...
  return (
    <button
      onClick={handleShare}
      className="w-full bg-[#25D366] hover:bg-[#DB2777] text-white font-bold py-4 px-6 rounded-full shadow-lg transition-all transform hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
    >
